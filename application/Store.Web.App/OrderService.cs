...
namespace Store.Web.App
{
    public class OrderService
    {
        ...
        public OrderModel SendConfirmation(string cellPhone)
        {
            ...
            {
                var confirmationCode = 1111; //todo Random
                ...
                model.Errors["cellPhone"] = "Number doesn't match proper format";
        ...
        public OrderModel ConfirmCellPhone(string cellPhone, int confirmationCode)
        {
            ...
            if(storedCode == null)
            {
                model.Errors["cellPhone"] = "Something went wrong.Try again.";
                return model;
            }
            if (storedCode != confirmationCode)
            {
                model.Errors["confirmationCode"] = "Incorrect Code. Try again.";
                return model;
            }
            var order = GetOrder();
